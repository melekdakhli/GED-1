...
public function storeFormation(Request $request)
{
     ...
     */
    public function showFormation(documents $documents)
    {
        $documents = Formation::all();
     ...
     */
    public function updateFormation(Request $request, $id) { // L'ID doit être un paramètre ici
        $document = Formation::findOrFail($id);
     ...
     */
    public function destroyFormation($id) // Changez la signature pour utiliser l'ID directement
    {
    ...
    public function downloadFormation($id)
    {
        $document = Formation::findOrFail($id);
    ...
    public function previewFormation($id)
    {
        $document = Formation::findOrFail($id);
        $filePath = storage_path('app/public/' . $document->file);
