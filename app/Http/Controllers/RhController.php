...
public function storeRh(Request $request)
{
     ...
     */
    public function updateRh(Request $request, $id) { // L'ID doit être un paramètre ici
        $document = Rh::findOrFail($id);
     ...
     */
    public function destroyRh($id) // Changez la signature pour utiliser l'ID directement
    {
        $document = Rh::find($id);
