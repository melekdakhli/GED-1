...
export class DocumentService {
  ...
  getDocuments(): Observable<Document[]> {
    return this.http.get<{ documents: Document[] }>(`${this.baseUrl}/showD`).pipe(
  ...
  addDocument(documentData: FormData): Observable<Document> {
    return this.http.post<Document>(`${this.baseUrl}/storeD`, documentData);
}



  deleteDocument(document: Document): Observable<Document> {
    return this.http.delete<Document>(`${this.baseUrl}/destroyD/${document.id}`);
  }
  ...
  updateDocument(document: Document): Observable<Document> {
    return this.http.put<Document>(`${this.baseUrl}/updateD/${document.id}`, document);
}


downloadDocument(documentId: number): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/downloadD/${documentId}`, {
...
downloadDocumentPreview(documentId: number): Observable<Blob> {
    return this.http.get(`${this.baseUrl}/previewD/${documentId}`, {
